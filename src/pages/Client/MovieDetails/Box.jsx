...
const Box = ({ detail }) => {
    ...
    useEffect(() => {
        ...
        const initialDates = [today, tomorrow];
        setDates(initialDates);

        // Tự động chọn ngày đầu tiên
        setSelectedDate(initialDates[0]);
        filterShowtimes(initialDates[0]);
        setShowTime(true); // Hiển thị khung thời gian
    }, []);
                ...
                <div className="w-full mx-auto">
                    ...
                    <div className="text-center mt-4">
                        <p className="text-orange-500 font-semibold">
                            Lưu ý: Khán giả dưới 13 tuổi chỉ chọn suất chiếu kết thúc trước 22h và Khán giả dưới 16 tuổi
